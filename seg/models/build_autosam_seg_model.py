...
def build_sam_vit_h_seg_cnn(num_classes=2, checkpoint=None):
...
def build_sam_vit_l_seg_cnn(num_classes=2, checkpoint=None):
    return _build_sam_seg_model(
...
def build_sam_vit_b_seg_cnn(num_classes=2, checkpoint=None):
    return _build_sam_seg_model(
